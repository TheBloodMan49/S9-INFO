...
use crate::png::PngError::{IncorrectHeader, NonExistantChunk};
...
impl Png {
    ...
    pub fn as_bytes(&self) -> Vec<u8> {
        let mut bytes = Vec::from(Self::STANDARD_HEADER);
...
impl Display for PngError {
    fn fmt(&self, f: &mut Formatter<'_>) -> std::fmt::Result {
        match self {
            PngError::IncorrectHeader => write!(f, "L'entête PNG est incorrecte!"),
            PngError::NonExistantChunk => write!(f, "Le bloc demandé n'existe pas!"),
        }
    }
}
